...
import Pic1 from "./img/bir1.jpg";
import Pic2 from "./img/anu.jpg";
import Pic3 from "./img/innstan.jpg";

// Import local playlist music files
import songA from "./music/Samaj.mp3";
import songB from "./music/Vellake.mp3";
import songC from "./music/Khaab.mp3";
...
const photos: Photo[] = [
  {
    url: Pic1,
    caption:
      "You always spread smiles and good vibes wherever you go. Wishing you a year full of growth, joy, and beautiful moments! 🌸",
  },
  {
    url: Pic2,
    caption:
      "You’re a beautiful soul, and I hope your day is as bright as your spirit. The world genuinely feels lighter when you’re around✨👑",
  },
  {
    url: Pic3,
    caption:
      "On your special day, I wish you a year full of exciting journeys, laughter, and everything your heart dreams of. 🌍💫",
  },
];

// Playlist song names
const playlist = ["Samajavaragamana", "Vellake", "Khaab"];
        ...
        <div className="flex flex-col justify-center space-y-8">
          ...
          <div className="backdrop-blur-md bg-white/30 rounded-2xl p-6 shadow-xl">
            <h3 className="text-2xl font-semibold text-purple-800 mb-4 flex items-center">
              <span className="mr-2">🎵</span>Your Mini Playlist 
            </h3>
          ...
          <div className="relative mx-auto">
            ...
            <motion.button
              ...
              onClick={onComplete}
            >
              I wrote something special for you, Anukriti Jii😄
            </motion.button>
          </div>
        </div>
      </div>
